    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-list-alt"></i> Sanction(s)</div>
        <div class="card-body">
					...
					<table  class="table table-list-search table-bordered table-condensed custab small">
						...
						<tbody>
							<?php
								...
								$sql="SELECT * FROM tbl_sanction WHERE archive = '1' ORDER BY item_name asc";
								...
								if ($result->num_rows > 0) {
								  ...
								  while($row = $result->fetch_assoc()) {
									...
									echo "<td>";
											?>
												<a onclick="return confirm('Are you sure you want to retrieve this sanction?')" href="archive_sanctions?del=<?php echo $row['salt']; ?>" class="btn btn-primary btn-sm"><i class='fa fa-fw fa-undo'></i></a>
											<?php
									echo "</td></tr>";	
								  }
								}
