...
<body onload="window.print()">
    ...
    <div class="container-fluid" style="font-size:90%;">
		...
		<?php
			...
			$sql_student = mysqli_query($con, "SELECT * FROM `tbl_students`");

			while ($row = mysqli_fetch_array($sql_student, MYSQLI_BOTH)){
			...
			echo "
				...
				<center><b>Student Clearance</b><br/><small>".$current_school_year." - ".$current_sem." SEMESTER</small><br/></center>
				<div class='row'>
