	  ...
	  <!-- Login Form -->
        ...
        <form name="frmLogin" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" role="form" enctype="multipart/form-data" onsubmit="return checkForm(this);">
          <div class="form-group">
            ...
            <input class="form-control" id="username" name="username" type="text" aria-describedby="" placeholder="Enter your username" value="<?php echo $uname; ?>" autofocus required maxlength="20" autocomplete="off">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Password</label>
            <input class="form-control" id="password" name="password" type="password" placeholder="Enter your password" required maxlength="20" onkeypress="capLock(event)" autocomplete="off">
