        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <i class="fa fa-users"></i> Student Violation Summary <span><a href="print_clist" class="btn btn-success btn-sm pull-right"><i class="fa fa-print"></i> print summary </a></span></div>
                    <div class="card-body">
                        <div class="table-responsive" style="margin-top:10px;">
                            <table class="table table-list-search table-bordered table-condensed custab small diplay" id="tblvio">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $sql="SELECT * FROM tbl_violation tv JOIN tbl_students ts ON tv.student_id=ts.student_id WHERE b2='1'";
