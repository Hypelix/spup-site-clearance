...
<?php if ($user_utype!="5") { ?>		
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapse" data-parent="#exampleAccordion">
            ...
            <span class='nav-link-text'>Violation</span>
            </a>
          ...
          ?>
            <li>
              <a class='nav-link' href="summary_violation">Summary per Violation</a>
            </li>
            <li>
              <a class='nav-link' href="comply_violation">Complied Violation</a>
            </li>
            <li>
              <a class='nav-link' href="ncomply_violation">Non-Complied Violation</a>
            </li>
          </ul>
          </li>
    ...
    <li class='nav-item' data-toggle='tooltip' data-placement='right' title='Example Pages'>
          ...
          <ul class='sidenav-second-level collapse' id='collapseExamplePages'>
              ...
              <li>
              <a href='archive_user'>Users Archive</a>
            </li>
          </ul>
          </li>
    ";
...
<?php if ($user_utype!="5") { ?>
<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseL" data-parent="#exampleAccordion">
            <i class='fa fa-fw fa-folder-open'></i>
            <span class='nav-link-text'>Reports</span>
            </a>
          <ul class='sidenav-second-level collapse' id='collapseL'>
            <li>
              <a class='nav-link' href="list_masterlist">Masterlist</a>
            </li>
            <li>
              <a class='nav-link' href="summary_violation">Violation Report</a>
            </li>
            <li>
              <a class='nav-link' href="list_clearance">Student Clearance</a>
            </li>
          </ul>
          </li>
        </li>
