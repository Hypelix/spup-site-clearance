		...
		<div class="container-fluid">
		 <!-- FORM UPDATE SEM -->
		  <hr/>
			...
			if($user_utype == "1" || $user_utype == "3" || $user_utype == "4") {
			?>
		  ...
		  <div class="card mb-3">
				...
				<div class="card-header">
					<i class="fa fa-table"></i> Students <span><a href="add_student" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> add student </a></span></div> <?php } ?>
				<div class="card-body">
					<form action="#" method="get">
						...
						<?php if($user_utype!="5") { ?>
							<div class="col-lg-8">
								...
								<span><a href="list_masterlist" class="btn btn-success btn-sm"><i class="fa fa-folder-open"></i> masterlist </a></span>
							</div>
							 <?php } ?>
							 <?php if($user_utype!="5") { ?>
							<div class="col-lg-4">
					...
					<div class="table-responsive" style="margin-top:10px;">
						<table class="table table-list-search table-bordered table-condensed custab small" style="font-size:70%;" id="tblstud">
							<thead>
								<tr>
									<th class="select-filter">#</th>
									<th class="select-filter">SY - Sem</th>
