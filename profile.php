      ...
      <div class="row">
		...
		<div class="col-md-8">
		  ...
		  <div class="card-body">
			<?php
				...
				$oldPass = $cEmail = $newPass = $cnewPass = ""; $x = 0;$success=0;
		...
		//check old pass
				...
				//check confirm new pass
					...
					$sql_trackemail = "SELECT * FROM tblusers WHERE username='$uname' AND email ='$cEmail'";
					...
					if(($newpp == $newPass) && ($password == $cpp) && ($x==0))
						{
							$success = 1;
						}
					...
					if ($success == 1) {
						// UPDATE DATA
						$sql_update = "UPDATE tblusers SET password='$newpp' WHERE user_id = '$user_id'";
