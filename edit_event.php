			  ...
			  <div class="form-group">
				<div class="form-row">
				  ...
				  <div class="col-md-6">
					...
					<select class="form-control" name="venue" value="<?php echo $venue;?>">
						<option value="1">Global Center</option>
						<option value="2">Student Center</option>
						<option value="3">Gymnasium</option>
						<option value="4">Mere Madeleine Hall</option>
						<option value="5">Granstand</option>
						<option value="6">BEU Gymnasium</option>
					</select>
				</div>
				</div>
				</div>
