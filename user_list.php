							...
							<?php
								//DELETE
									if(isset ($_GET['del'])) {
										$salt = $_GET['del'];
										$archive = "1";
										$sql="UPDATE tblusers SET archive='$archive' WHERE salt='$salt'";
								...
								//SHOW USERS
								$sql="SELECT * FROM tblusers WHERE archive=0 ORDER BY username asc ";
								...
								if ($result->num_rows > 0) {
								  ...
								  while($row = $result->fetch_assoc()) {
									...
									if ($user_type == "5") {
										...
										echo "<td>";
										?>
										<a onclick="return confirm('Are you sure you want to delete this user?')" href="user_list?del=<?php echo $row['salt']; ?>" class="btn btn-danger btn-sm"><i class='fa fa-fw fa-trash'></i></a>
										<?php
